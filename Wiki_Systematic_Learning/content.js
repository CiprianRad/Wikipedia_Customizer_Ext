...
function parseSections() {
  ...
  // Wikipedia recently started wrapping content in <section> tags.
  // Flatten the children array so our flat-DOM parsing still works seamlessly.
  let children = [];
  for (const child of parserOutput.children) {
